...
use CodeIgniter\Model;
 ...
 class UsuarioModel extends Model
 {
     ...
     protected $allowedFields = ['nombre', 'apellido', 'usuario', 'cedula', 'password','telefono','biografia','roles','avatares'];
    }
    //EN EL MODELO AGREGUE EL ULTIMO CAMPO DE TELEFONO PARA QUE ME GUARDE EL NUMERO 
